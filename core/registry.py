"""
Usajili wa vitu vinavyosimamiwa ndani ya dashibodi ya MUWESTA.
...
REGISTRY = {
    ...
    "matangazo": {
        ...
        "icon": "megaphone", "columns": [("title", "Kichwa"), ("status", "Hali"),
                                         ("published_on", "Tarehe"), ("is_active", "Hai")],
        "fields": ["title", "title_en", "body", "body_en", "icon", "tint",
                   "audience", "published_on", "is_urgent", "status", "is_active"],
        "search": ["title"], "filters": ["status", "audience", "is_active"],
    },
    "albamu": {
