...
class Command(BaseCommand):
    ...
    def branches(self):
        ...
        Branch.objects.get_or_create(name="Ofisi Kuu - Dodoma", defaults={
            "region": dodoma, "address": "Shariff PBZ House, Nyerere Square, Dodoma",
        ...
        offices = {
            ...
            "kati": ("Ofisi ya Kanda ya Kati", "Dodoma",
                     "Shariff PBZ House, Nyerere Square, Dodoma", "+255 769 600 102"),
    ...
    def categories(self):
        data = [
            ...
            ("Tanzanite", "T", 200000, 200, "#1b3b6f", 4, False,
             "Faida zote za Diamond\nUtambulisho wa kudumu kwenye ukumbi wa heshima\n"
    ...
    def site_content(self):
        ...
        for y, t, ten, b, ben, o in [
            ("2015", "Kuanzishwa kwa MUWESTA", "MUWESTA Founded",
            ...
            ("2018", "Upanuzi wa Kitaifa", "National Expansion",
             "MUWESTA ilifungua matawi katika mikoa 12 na kuanzisha mfumo wa uanachama wa kudumu.",
             "MUWESTA opened branches in 12 regions and established a permanent membership system.", 1),
        ...
        faqs = [
            ("kuhusu", "MUWESTA ni nini?", "What is MUWESTA?",
             "MUWESTA ni jumuiya ya kijamii isiyo ya kiserikali inayotoa huduma za elimu, afya, "
             "ustawi na uwezeshaji kiuchumi kwa jamii ya Watanzania.",
             "MUWESTA is a non-governmental community organisation providing education, health, "
            ...
            ("mawasiliano", "Nawezaje kujiunga na MUWESTA?", "How do I join MUWESTA?",
    ...
    def events(self, members, limit):
        ...
        titles = [
            ...
            ("Mkutano Mkuu wa MUWESTA", "MUWESTA Annual General Meeting"),
        ...
        for i, (t, ten) in enumerate(titles[:limit]):
            ...
            ev = Event.objects.create(
                ...
                venue=f"Ukumbi wa MUWESTA - {region.name}",
                venue_en=f"MUWESTA Hall - {region.name}",
    ...
    def media(self, limit):
        ...
        photos = [
            ("Mkutano Mkuu wa MUWESTA 2026", "MUWESTA AGM 2026", "mkutano", "matukio", 2.4, 36),
        ...
        videos = [
            ...
            ("Mkutano Mkuu wa MUWESTA 2026.mp4", "MUWESTA AGM 2026.mp4", "mkutano", "matukio", 15.3, "03:18"),
    ...
    def news(self, limit):
        ...
        today = timezone.localdate()
        items = [
            ("MUWESTA yatoa msaada kwa familia zilizoathiriwa na mafuriko Dodoma",
             "MUWESTA delivers aid to flood-affected families in Dodoma",
             "MUWESTA imekabidhi msaada wa vyakula, mavazi na vifaa muhimu kwa familia 120 "
             "zilizoathirika na mafuriko katika wilaya za Chamwino na Bahi. Msaada huu una "
             "thamani ya zaidi ya TZS 85 milioni.",
             "MUWESTA has delivered food, clothing and essential supplies to 120 families "
