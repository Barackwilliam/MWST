...
urlpatterns = [
    ...
    path("matangazo/<int:pk>/", views.tangazo, name="tangazo"),
    path("vifurushi/", views.vifurushi, name="vifurushi"),
    ...
    #: Selcom: ukurasa wa kusubiri wakati mtu anaingiza PIN, hali kwa JSON
    #: inayoulizwa na ukurasa huo, na webhook ya Selcom yenyewe.
    path("selcom/subiri/<str:receipt>/", views.selcom_subiri, name="selcom_subiri"),
    path("selcom/hali/<str:receipt>/", views.selcom_hali, name="selcom_hali"),
    path("selcom/webhook/", views.selcom_webhook, name="selcom_webhook"),
    path("changia/asante/<str:receipt>/", views.changia_asante, name="changia_asante"),
    path("mhisani/jisajili/", views.donor_register, name="donor_register"),
    path("mhisani/", views.donor_dashboard, name="donor_dashboard"),
